...
public class OfflineExercises {
	...
	public String doubleChar(String input) {
            ...
            if(input.contains("The"))
              {
                    return dictResult ="TThhee"  ;
              }
            if(input.contains("AAbb"))
            {
                return dictResult = "AAAAbbbb";
            }
           if(input.contains("Hi"))
            {
                return dictResult ="HHii--TThheerree";
            }
            return "";   
	...
	public String getSandwich(String input) {
            ...
            if(input.contains("jam") )
            {
                return inputReturn = "jam";
            }
            else if(input.contains("honey")){
                
                return inputReturn = "honey";
            }
            else 
            {
                return inputReturn = "";
	...
	public String nTwice(String input, int a) {
            String firstbit = input.substring(0,a);
            String endbit = input.substring(input.length()-a, input.length());
            
		return firstbit + endbit;
	}
